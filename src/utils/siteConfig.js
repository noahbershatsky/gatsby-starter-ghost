...
module.exports = {
    siteUrl:
        process.env.NODE_ENV === `production`
            ? process.env.SITE_URL || config.siteUrl || `https://bershatsky.net/`
            : `https://bershatsky.net/`, // Site domain. Do not include a trailing slash!
    ...
    shortTitle: `Bershatsky`, // Used for App manifest e.g. Mobile Home Screen
